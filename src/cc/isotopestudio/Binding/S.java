...
public class S {
    ...
    public static String toPrefixYellow(String s) {
        return Binding.prefix + ChatColor.YELLOW + s + ChatColor.RESET;
    }

    public static String toPrefixGray(String s) {
        return Binding.prefix + ChatColor.GRAY + s + ChatColor.RESET;
    }
    ...
    public static String toPrefixAqua(String s) {
        return Binding.prefix + ChatColor.AQUA + s + ChatColor.RESET;
    }
}
